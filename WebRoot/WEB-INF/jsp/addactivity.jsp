...
<html>
	...
	<body>
		<div id="container">
				<form
					action="${pageContext.request.contextPath }/servlet/AddActivityServlet?username=${username }"
					method="post">
					...
					<div id="button">
						...
						<input type="submit" value="预  约" class="myButton" />
					</div>
				</form>
		</div>
	</body>
